...
<div class="container my-3">
  <div class="d-flex flex-row-reverse bd-highlight" style="border-right-style: solid; border-right-width: 5px;border-color: #28a745;">
    ...
    <div class="p-1 bd-highlight">
      ...
      class="btn btn-white border x-button-prev py-1 btn-sm">عرض الكل</button>
    </div>
...
<div class="container">
  <div class="row">
      @for ($i = 0; $i < 4; $i++)
      <div id="grid_mobile" class="mb-5 col-6 col-lg-3 col-sm-4">
        <div class="card card_Producer border-0" style="position: relative;">
            <p class="py-0 px-2 bg-success text-white" style="position: absolute;border-radius: 10px 0px 0px 10px;">
              <small>50 جرام</small>
            </p>
            <div class="mb-2">
            ...
            <div class="card-block">
              ...
              <p class="text-left p-0 mx-2 h6 mb-2 h7"><small class="text-muted">مذاق شرق</small></p> 
              <div class="clearfix mx-2">
                <a class="text-secondary float-right swiper-icon" onclick="dcfsd()">
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-shopping-cart" width="25" height="25" viewBox="0 0 24 24" stroke-width="1" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <circle cx="9" cy="19" r="2" />
                    <circle cx="17" cy="19" r="2" />
                ...
                <span class="align-baseline text-success float-left font-weight-bolder"> 352{{$i}} ريال </span>
              </div>
            </div>
        </div>
      </div>
        ...
        <div class="card card_Producer border-0" style="position: relative;">
            ...
            <div class="card-block">
              ...
              <div class="clearfix mx-2">
                ...
                <span class="align-baseline text-muted float-left font-weight-bolder mx-1"> <del> <small>352{{$i}} ريال</small> </del> </span>
              </div>
            </div>
        </div>
      </div>
...
<div class="container">
  <div class="row">
      @for ($i = 1; $i < 3; $i++)
      <div id="grid_mobile" class="mb-5 col-6 col-lg-3 col-sm-4">
        <div class="card card_Producer border" style="position: relative;">
            <p class="py-0 px-2 bg-success text-white" style="position: absolute;border-radius: 10px 0px 0px 10px;">
              <small>50 جرام</small>
            </p>
