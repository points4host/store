...
<div class="bg-white p-2 rounded shadow-sm">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('measurement.index') }}">وحدة القياس</a></li>
        <li class="breadcrumb-item active" aria-current="page">إضافة وحدة قياس جديدة</li>
    </ol>
...
<div class="bg-white p-4 rounded shadow-sm">
    ...
    <form method="POST" action="{{ route('measurement.store')}}">
        ...
        <div class="form-group row">
            <label for="staticEmail" class="col-sm-1 col-form-label">وحدة القياس</label>
            <div class="col-sm-11">
                <input type="text" class="form-control" name="name" required placeholder="وحدة القياس">
            </div>
        </div>
